...
/// Adds pattern-matching-related methods to [FinalPhaseCompleteEventData].
extension FinalPhaseCompleteEventDataPatterns on FinalPhaseCompleteEventData {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FinalPhaseCompleteEventData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FinalPhaseCompleteEventData() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FinalPhaseCompleteEventData value)  $default,){
final _that = this;
switch (_that) {
case _FinalPhaseCompleteEventData():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FinalPhaseCompleteEventData value)?  $default,){
final _that = this;
switch (_that) {
case _FinalPhaseCompleteEventData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( FinalRoundPhase phase,  FinalRoundPhase nextPhase,  GameStateTimer timer)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FinalPhaseCompleteEventData() when $default != null:
return $default(_that.phase,_that.nextPhase,_that.timer);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( FinalRoundPhase phase,  FinalRoundPhase nextPhase,  GameStateTimer timer)  $default,) {final _that = this;
switch (_that) {
case _FinalPhaseCompleteEventData():
return $default(_that.phase,_that.nextPhase,_that.timer);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( FinalRoundPhase phase,  FinalRoundPhase nextPhase,  GameStateTimer timer)?  $default,) {final _that = this;
switch (_that) {
case _FinalPhaseCompleteEventData() when $default != null:
return $default(_that.phase,_that.nextPhase,_that.timer);case _:
  return null;

...
/// Adds pattern-matching-related methods to [FinalRoundQuestionData].
extension FinalRoundQuestionDataPatterns on FinalRoundQuestionData {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FinalRoundQuestionData value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FinalRoundQuestionData() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FinalRoundQuestionData value)  $default,){
final _that = this;
switch (_that) {
case _FinalRoundQuestionData():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FinalRoundQuestionData value)?  $default,){
final _that = this;
switch (_that) {
case _FinalRoundQuestionData() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int themeId,  String themeName,  Question question)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FinalRoundQuestionData() when $default != null:
return $default(_that.themeId,_that.themeName,_that.question);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int themeId,  String themeName,  Question question)  $default,) {final _that = this;
switch (_that) {
case _FinalRoundQuestionData():
return $default(_that.themeId,_that.themeName,_that.question);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int themeId,  String themeName,  Question question)?  $default,) {final _that = this;
switch (_that) {
case _FinalRoundQuestionData() when $default != null:
return $default(_that.themeId,_that.themeName,_that.question);case _:
  return null;

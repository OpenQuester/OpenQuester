...
export class AddSearchIndexes_0_15_3_1738083600000
  implements MigrationInterface
{
  name = "AddSearchIndexes_0_15_3_1738083600000";
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query("DROP INDEX IF EXISTS idx_package_author_created_at");

...
> {
  public async execute(
    ...
    const readyPlayers = PlayerReadinessLogic.updateReadyState(game, playerId, false);
    ...
    return {
      ...
      mutations: [
        ...
        ...DataMutationConverter.mutationFromSocketBroadcasts(readinessResult.broadcasts)
      ],
      broadcastGame: game
    };
  }

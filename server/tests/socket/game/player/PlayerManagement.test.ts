...
describe("SocketIOGameLobby", () => {
  ...
  it("should successfully change player score", async () => {
    ...
    const scoreChangeEventPromise = utils.waitForEvent<PlayerScoreChangeBroadcastData>(
      setup.showmanSocket,
  ...
  it("should successfully change turn player", async () => {
    ...
    const turnChangeEventPromise = utils.waitForEvent<TurnPlayerChangeBroadcastData>(
      setup.showmanSocket,
  ...
  it("should successfully change player slot", async () => {
    ...
    const slotChangeEventPromise = utils.waitForEvent<PlayerSlotChangeBroadcastData>(
      setup.showmanSocket,
  ...
  it("should prevent non-showman from changing another player's slot", async () => {
    ...
    const errorPromise = utils.waitForEvent(setup.playerSockets[0], SocketIOEvents.ERROR);
  ...
  it("should prevent changing to occupied slot", async () => {
    ...
    const errorPromise = utils.waitForEvent(setup.showmanSocket, SocketIOEvents.ERROR);
